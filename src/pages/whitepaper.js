...
function WhitepaperPage(props) {
  ...
  <b id="Abstract" style={{paddingTop:'5px', paddingBottom:'5px'}}><FormattedMessage id="Abstract" defaultMessage="ABSTRACT"/></b>
      <FormattedMessage id="Abstract1" defaultMessage="What is the difference between each of us? Our value. This criterion seems to be subjective. Therefore, none objective parameter exist yet to assess human value on an individual scale. This societal issue joins another: the social elevator disappearance. Unlike other crypto currencies, HVSEcoin will not be a goal but a means; the means to assess your added value,  the means to improve yourself. To do this, HVSEcoin is the only way to access a new market: that of human values (Human Value Stock Exchange)." style={{paddingTop:'5px', paddingBottom:'5px'}}/>
      <b id="Introduction" style={{paddingTop:'5px', paddingBottom:'5px'}}><FormattedMessage id="Introduction" defaultMessage="1. INTRODUCTION"/></b>
      <p></p>
      <b id="History" style={{paddingTop:'5px', paddingBottom:'5px'}}><FormattedMessage id="History" defaultMessage="1.1. History Lesson"/></b>
      <p style={{paddingTop:'5px', paddingBottom:'5px'}}> <FormattedMessage id="hist1" defaultMessage="There are 3 generations of cryptocurrencies."/><b><FormattedMessage id="hist2" defaultMessage=" The first generation"/></b><FormattedMessage id="hist3" defaultMessage=" is represented by Bitcoin (2009). Strongly established, initiator of the media and public madness for cryptocurrencies, it suffers from regularly pointed out shortcomings, such as its slowness, its relatively small block size, in particular."/></p>
      <p style={{paddingTop:'5px', paddingBottom:'5px'}}> <b><FormattedMessage id="hist4" defaultMessage="The second generation"/></b><FormattedMessage id="hist5" defaultMessage=" (2011) presents either minor improvements or technological innovations allowing new functions. The archetype  is Ethereum (which is derived from the source code of Bitcoin), which makes use of smart contracts."/></p>
      <p style={{paddingTop:'5px', paddingBottom:'5px'}}><b><FormattedMessage id="hist6" defaultMessage="The third generation"/></b><FormattedMessage id="hist7" defaultMessage=" (since 2017): Noticing new limitations, notably in capacity, security and governance. New cryptocurrencies have emerged, such as EOS.IO, Cardano (ADA), AION, ICON (ICX) and Raiden Network (RDN), for the best known. EOS.IO is itself derived from Ethereum. They bring innovations, but, in August 2018, none has gained the upper hand over the others."/></p>
      <b id="curtok"><FormattedMessage id="curtok" defaultMessage="1.2. A new currency or a new token?"/></b>
      <p><FormatedMessage id="curtok1" defaultMessage="Typically, crypto tokens are programmable, permissionless, trustless, and transparent. Programmable simply means that they run on software protocols, which are composed of smart contracts that outline the features and functions of the token and the network’s rules of engagement. Permissionless means that anyone can participate in the system without the need for special credentials. Trustless means that no one central authority controls the system; instead it runs on the rules predefined by the network protocol. And finally, transparency implies that the rules of the protocol and its transactions are viewable and verifiable by all."/></p>
      <p><FormatedMessage id="curtok2" defaultMessage=" While crypto tokens, like cryptocurrency, can hold value and be exchanged, they can also be designed to represent physical assets or more traditional digital assets, or a certain utility or service. For instance, there are crypto tokens that represent tangible assets such as real estate and art, as well as intangible assets such as processing power or data storage space. Tokens are also frequently used as a governance mechanism for voting on specific parameters like protocol upgrades and other decisions that dictate the future direction of various blockchain projects. The process of creating crypto tokens to serve these various functions is known as tokenization."/></p>
      <p><FormatedMessage id="curtok3" defaultMessage="After our market study, we have concluded that a new currency can't offer several new things. Indeed, our personal profits in this enterprise don't matter. So, we have chosen to create a new token and not a new cryptocurrency."/></p>
      <p><FormatedMessage id="curtok4" defaultMessage=" HVSEcoin is a ERC20 token based on the Ether. This choice was conducted due to different reasons:"/></p>
      <p><FormatedMessage id="curtok5" defaultMessage=" 1. a solid network of applications;"/></p>
      <p><FormatedMessage id="curtok6" defaultMessage=" 2. a mutation in progress from the Proof of Work consensus mechanism to the Proof of Stake consensus mechanism (thanks to ETH 2.0);"/></p>
      <p><FormatedMessage id="curtok7" defaultMessage=" 3. ERC20 allows for seamless interaction with other smart contracts and decentralized applications on the Ethereum blockchain. Tokens that have some but not all of the standard functions are considered to be partially ERC20 compliant and can still be easy for external parties to interact with depending upon which functions are missing."/></p>
      <p><FormatedMessage id="curtok8" defaultMessage=" We define 'staking' as the action to bet HVSEcoin on a person."/></p>
