...
function WhitepaperPage(props) {
  ...
  <b id="Abstract"><FormattedMessage id="Abstract" defaultMessage="ABSTRACT"/></b>
     <p><FormattedMessage id="Abstract1" defaultMessage="What is the difference between each of us? Our value. This criterion seems to be subjective. Therefore, none objective parameter exist yet to assess human value on an individual scale. This societal issue joins another: the social elevator disappearance. Unlike other crypto currencies, HVSEcoin will not be a goal but a way; the way to assess your added value,  the way to improve yourself. To do this, HVSEcoin is the only way to access a new market: that of human values (Human Value Stock Exchange)."/></p>
