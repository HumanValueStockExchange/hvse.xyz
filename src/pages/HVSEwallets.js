...
const HVSEwallets = () => {
  return (
    ...
    children2={<div><p className="font-semibold text-xl" style={{fontSize: '1.25rem', lineHeight: '1.75rem', fontWeight: '600', marginBottom:'8'}}>HVSEcore</p><p className="mt-4" style={{marginTop: '4', textAlign:'left'}}>HVSEcore will be at the same time a wallet and a plateform to bet on <a href="/WhatAreIHVTs">IHVTs</a>. More details coming.</p></div>}
