...
const HVSEwallets = () => {
  return (
    ...
    <Card
    id="HVSE wallets"
    children1={<div><p className="font-semibold text-xl" style={{fontSize: '1.25rem', lineHeight: '1.75rem', fontWeight: '600', marginBottom:'8'}}>Swap</p><p className="mt-4"  style={{marginTop: '4', textAlign:'left'}}>Firstly, <a href="/WhatIsHVSEcoin">HVSEcoin</a> will be available in UniSwap and then you could hodl them in your Metamask wallet. More details released after the HVSEcoin deployement.</p></div>}
    children2={<div><p className="font-semibold text-xl" style={{fontSize: '1.25rem', lineHeight: '1.75rem', fontWeight: '600', marginBottom:'8'}}>HVSEcore</p><p className="mt-4" style={{marginTop: '4', textAlign:'left'}}>HVSEcore will be at the same time a wallet and a plateform to bet on <a href="/WhatAreIHVPTs">IHVPTs</a>. More details coming.</p></div>}
