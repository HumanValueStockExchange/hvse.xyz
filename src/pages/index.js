...
function IndexPage(props) {
  return (
    ...
    <div id="roadmap" className="py-20 lg:pt-32" style={{paddingTop:'5em', paddingBottom:'5em', color:'var(--textNormal)'}}>
        <LabelText className="text-600" style={{color:'var(--textNormal)'}}><FormattedMessage id="roadmap" defaultMessage="TRAILMAP"/></LabelText>
            ...
            <span class="label">HVSEcore 2.0.</span>
		      ...
		      <div class="dot-info" data-description="09/2023">
		        ...
		        <div id="timeline-descriptions-wrapper">
			        ...
			        <FormattedMessage id="block-depsub1" defaultMessage="HVSEcoin and IHVPT blockchains published on GitHub."/>
			        <FormattedMessage id="block-depsub2" defaultMessage="Deployement of HVSEcoin."/>
			        <FormattedMessage id="block-depsub3" defaultMessage="Deployment of the liquidity pool on Uniswap."/>
			        <FormattedMessage id="block-depsub4" defaultMessage="Listing on CoinGecko and on CoinMarketCap."/>
			        <FormattedMessage id="block-depsub5" defaultMessage="First Security Audit."/>
			        <FormattedMessage id="block-depsub6" defaultMessage="Website implementation in 3.0."/>
			        </p>
			        <p data-description="09/2022">
			        <FormattedMessage id="hvsec1" defaultMessage="First release of HVSEcore, our main software: a wallet and a DEX to buy/sell HVSEcoin."/></p>
