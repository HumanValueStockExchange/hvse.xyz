...
const StakeOnIHVPTs = () => {
  return (
    <Layout>
    <div class="container">
    <div class="mainbox" style={{outline:'none', borderColor: 'inherit',  boxShadow: 'none', textAlign:'center'}}><p style={{fontWeight:'100', fontSize: '1.25rem', lineHeight: '2rem', whiteSpace:'nowrap', textAlign:'center'}}>Stake on IHVPTs</p></div>
          <div class="img">
    ...
    <Card
    id="Stake on IHVPTs"
    children1={<div><p className="font-semibold text-xl" style={{fontSize: '1.25rem', lineHeight: '1.75rem', fontWeight: '600', marginBottom:'8'}}>Bet</p><p className="mt-4"  style={{marginTop: '4', textAlign:'left'}}>Thanks to HVSEcore, you are able to bet some <a href="/WhatIsHVSEcoin">HVSEcoins</a> by buying <a href="/WhatAreIHVPTs">IHVPTs</a>.</p></div>}
    children2={<div><p className="font-semibold text-xl" style={{fontSize: '1.25rem', lineHeight: '1.75rem', fontWeight: '600', marginBottom:'8'}}>Withdrawal</p><p className="mt-4" style={{marginTop: '4', textAlign:'left'}}>Thanks to HVSEcore, you are able to withdrawal some <a href="/WhatIsHVSEcoin">HVSEcoins</a> by selling <a href="/WhatAreIHVPTs">IHVPTs</a>.</p></div>}
